...
.factory('storeFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
    ...
    return $resource(baseURL + "stores/:id", null, {
            'update': {
                method: 'PUT'
            } 
        });
...
.factory('orderFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
    ...
    return $resource(baseURL + "orders/:id", { id: '@_id' }, {
            'update': {
                method: 'PUT'
            }
        });
...
.service('infoExchange', function() {
  var selectedStore = {};

  var setStore = function(store) {
      selectedStore = store;
      console.log('Selected store set :'+ selectedStore.storename);
  };

  var getStore = function(){
      console.log('Selected store returned :'+ selectedStore.storename);
